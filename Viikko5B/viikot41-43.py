...
#tulostetaan taulukko vko 43
    ...
    # --- VALIKKO ---
    print("Valikko:")
    print("1) Luo raportti kaikista viikoista")
    print("2) Luo raportti vain yhdestä viikosta")
    valinta = input("Valitse (1/2): ")

    if valinta == "1":
        # tänne koodi joka luo kaikki raportit
        # esim. kirjoitetaan tiedostoon kaikki viikot
        with open("Yhteenvetobonus.txt", "w", encoding="utf-8") as f:
            f.write("Raportti kaikista viikoista\n")
            f.write("...\n")
            f.write(Kaikkiyht)  
           
        print("Raportti kaikista viikoista luotu.")

    elif valinta == "2":
        viikko = input("Anna viikkonumero (41/42/43): ")
        if viikko == "41":
            # kirjoita vain viikko41
            with open("Yhteenvetobonus.txt", "w", encoding="utf-8") as f:
                f.write("Raportti viikosta 41\n")
                f.write("...\n")
                f.write(Viikko41yht)
                print("Raportti viikosta 41 luotu.")
        elif viikko == "42":
            with open("Yhteenvetobonus.txt", "w", encoding="utf-8") as f:
                f.write("Raportti viikosta 42\n")
                f.write("...\n")
                f.write(Viikko42yht)
                print("Raportti viikosta 42 luotu.")
            ...
        elif viikko == "43":
           with open("Yhteenvetobonus.txt", "w", encoding="utf-8") as f:
                f.write("Raportti viikosta 43\n")
                f.write("...\n")
                f.write(Viikko43yht)
                print("Raportti viikosta 43 luotu.")
                ...
        else:
            print("Tuntematon viikkonumero.")
